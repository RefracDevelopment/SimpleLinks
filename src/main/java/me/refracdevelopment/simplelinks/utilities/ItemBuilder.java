...
public class ItemBuilder {
    ...
    public ItemBuilder setName(String name) {
        ...
        im.setDisplayName(me.refracdevelopment.simplelinks.utilities.chat.Color.translate(name));
        is.setItemMeta(im);
        return this;
    }
    ...
    public ItemBuilder addLoreLine(String line) {
        ...
        lore.add(me.refracdevelopment.simplelinks.utilities.chat.Color.translate(line));
        im.setLore(lore);
        is.setItemMeta(im);
        return this;
    }
